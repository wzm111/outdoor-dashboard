...
| 标签 | 内容 |
|------|------|
| 总览 | 关键统计卡片（总活动/里程/爬升/时长/近 30 天里程/装备数/**身体年龄**）+ **美化体能档案卡片**（等级徽章、指标网格、需关注提示、当前目标、身体年龄）+ 最近 5 次活动 |
| 活动 | 全部活动表格（日期、路线、距离、爬升、时长、心率、感受），支持手动新增/编辑/删除 + AI 一句话录入；**支持同一天同路线保存多条记录，自动按 sequence 编号（#2/#3...）** |
