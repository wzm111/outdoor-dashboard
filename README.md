...
> 当前版本：**v30-2026-07-06**。前端已拆分为模块化 JS（version/utils/state/idb/api + view-*），零构建步骤。详见源码目录。
...
| 标签 | 内容 |
|------|------|
| 总览 | 关键统计卡片（总活动/里程/爬升/时长/近 30 天里程/装备数）+ **美化体能档案卡片**（等级徽章、指标网格、需关注提示、当前目标）+ 最近 5 次活动 |
