...
| 活动 | 全部活动表格（日期、路线、距离、爬升、时长、心率、感受），支持手动新增/编辑/删除 + AI 一句话录入；点击行打开运动类型专属详情弹窗（统计、天气、不适、备注、装备）；**支持同一天同路线保存多条记录，自动按 sequence 编号（#2/#3...）** |
